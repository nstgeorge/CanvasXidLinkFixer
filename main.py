...
if __name__ == "__main__":
    ...
    parser.add_argument('course', help="Link to the Canvas course to modify. Expects a direct homepage link.")
    ...
    with contextlib.closing(browser) as driver:
        print("Beginning course link fix on {}...".format(args.course))
        driver.get(args.course)
